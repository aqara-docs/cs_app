...
OLD_JOURNAL_SPREADSHEET_ID = os.getenv('OLD_JOURNAL_SPREADSHEET_ID')
OLD_JOURNAL_WORKSHEET_NAME = os.getenv('OLD_JOURNAL_WORKSHEET_NAME') 
# Open the worksheet
sheet = gc.open_by_key(OLD_JOURNAL_SPREADSHEET_ID).worksheet(OLD_JOURNAL_WORKSHEET_NAME)
